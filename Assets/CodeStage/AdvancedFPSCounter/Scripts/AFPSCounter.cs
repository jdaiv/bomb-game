...
namespace CodeStage.AdvancedFPSCounter
{
	...
	public class AFPSCounter: MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			{
				Debug.LogWarning(LOG_PREFIX + "Keep Alive option will not work at the non-root Game Object!");
			}
		...
		private void ConfigureLabels()
		{
			...
			for (int i = 0; i < anchorsCount; i++)
			{
				labels[i] = new DrawableLabel(canvas.gameObject, (LabelAnchor)i, paddingOffset, labelsFont, fontSize, lineSpacing);
			}
		}
